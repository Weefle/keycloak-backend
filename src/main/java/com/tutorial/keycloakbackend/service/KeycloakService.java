        ...
        int statusId = 0;
         try {
             ...
             if(statusId == 201){
                 ...
                 message.setMessage("Utilisateur créé avec succès");
             }else if(statusId == 409){
                 message.setMessage("Cet utilisateur existe déjà");
             }else{
                 message.setMessage("Erreur lors de la création de l'utilisateur");
             }
         }catch (Exception e){
             e.printStackTrace();
         }
